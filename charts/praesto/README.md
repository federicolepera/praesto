...
Pin release images explicitly for v0.6.1:
...
| `csi.image.tag` | `0.6.1` | CSI node driver image tag |
...
| `nodeAgent.image.tag` | `0.6.1` | Node-agent image tag |
